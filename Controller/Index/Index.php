...
class Index implements HttpGetActionInterface
{
    ...
    public function save(): bool
    {
        \Magento\Framework\App\ObjectManager::getInstance()
            ...
            ->pushHandler(new \Monolog\Handler\StreamHandler(\Magento\Framework\App\ObjectManager::getInstance()->
                get('\Magento\Framework\Filesystem\DirectoryList')->getRoot() . '/var/log/custom.log'))
            ->debug('1212121212121212121212');
